...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Magentoyan_SpinToWin::grid_list');
        $resultPage->getConfig()->getTitle()->prepend(__('Slice List'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Magentoyan_SpinToWin::grid_list');
    }
}
